      ...
      <div className="max-w-7xl mx-auto space-y-6">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
          {[
            ...
            { value: stats.virtualEvents, label: 'Virtual Events', color: 'text-blue-400', icon: <Globe className="w-5 h-5" /> },
            { value: stats.paidEvents, label: 'Paid Events', color: 'text-emerald-400', icon: <DollarSign className="w-5 h-5" /> },
            { value: stats.upcomingEvents, label: 'Upcoming', color: 'text-amber-400', icon: <Clock className="w-5 h-5" /> }
          ].map((stat, index) => (
                ...
                <div className="card-body">
                  ...
                  <div className="flex justify-between items-start mb-4">
                    ...
                    <div className="flex items-center gap-2">
                      ...
                      {event.is_virtual ? (
                        <span className="badge badge-info badge-sm">Virtual</span>
                      ) : (
                        <span className="badge badge-warning badge-sm">In-person</span>
                      )}
                    </div>
                  </div>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
                    ...
                    <div className="flex items-center text-gray-400">
                      ...
                      <span>{event.price === "0.00" || event.price === "0" ? "Free" : `$${event.price}`}</span>
                    </div>
                    <div className="flex items-center text-gray-400">
                  ...
                  {expandedEvent === event.id && (
                    <div className="space-y-4 pt-4 border-t border-[#334155]">
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <div>
                          <p className="text-gray-300 font-medium mb-2">Event ID</p>
                          <p className="text-gray-400">{event.id}</p>
                        </div>
                        <div>
                          <p className="text-gray-300 font-medium mb-2">Created On</p>
                          <p className="text-gray-400">{formatDate(event.created_at)}</p>
                        </div>
                      </div>
                    ...
                    <div className="flex items-center gap-2">
                      <div className="dropdown dropdown-end">
                        ...
                        <ul tabIndex={0} className="dropdown-content z-[1] menu p-2 shadow bg-[#1E293B] rounded-box w-52 border border-[#334155]">
                          ...
                          <li><a onClick={() => handleViewAnalytics(event.id)}><Eye className="w-4 h-4" /> View Analytics</a></li>
