...
const Mentorship = () => {
  ...
  useEffect(() => {
    ...
    const fetchMentorships = async () => {
      try {
        const res = await axiosSecure.get(`/api/mentor/${userId}`);
  ...
  const filteredMentorships = myMentorships.filter((mentorship) => {
    const matchesSearch =
      ...
      mentorship.specialties.some((specialty) =>
  ...
  const handleDeleteMentorship = (mentorshipId) => {
    if (
      window.confirm(
        "Are you sure you want to delete this mentorship offering?"
      )
    ) {
  ...
  const toggleExpandMentorship = (mentorshipId) => {
    setExpandedMentorship(
      expandedMentorship === mentorshipId ? null : mentorshipId
    );
  };

  const stats = {
    totalMentorships: myMentorships.length,
    activeMentorships: myMentorships.filter((m) => m.status === "active")
      .length,
        ...
        <div className="flex flex-col md:flex-row md:items-center md:justify-between">
          <div>
            ...
            <p className="text-gray-400 mt-2">
              Manage your mentorship offerings
            </p>
          </div>
              ...
              <div className="card-body">
                  ...
                  <div>
                    ...
                    <div className="flex items-center gap-2 mt-1">
                      <span className="text-gray-400">
                        Post Created: {formatDate(mentorship.created_at)}
                      </span>
                    </div>
                  </div>
                  <div className="flex items-center gap-2">
                    ...
                    <div className="dropdown dropdown-end">
                      ...
                      >
                        <li>
                          <a
                            onClick={() => handleEditMentorship(mentorship.id)}
                          >
                        ...
                        <li>
                          <a
                            onClick={() =>
                              handleDeleteMentorship(mentorship.id)
                            }
                ...
                <div className="flex flex-wrap gap-4 text-sm text-gray-400 mb-4">
                  <div className="flex items-center gap-1">
                    ...
                    <span>{mentorship.max_mentees} mentees</span>
                  </div>
                  <div className="flex items-center gap-1">
