...
const DashboardLayout = () => {
  ...
  useEffect(() => {
    ...
    else if (path.includes('recommendations')) setActiveSection('recommendations');
  ...
  const subLinkClasses = ({ isActive }) =>
    `block p-2 text-sm transition-colors ${isActive
      ...
      return [
        ...commonItems,
        {
          ...
          subItems: [
            ...
            { label: 'Collaborations', href: '/dashboard/projects/collaborations' }
          ]
        },
        {
          id: 'jobs',
        ...
        },
        {
          ...
          subItems: [
            { label: 'Create Mentorship', href: '/dashboard/mentorship/create' },
            { label: 'Mentorship Requests', href: '/dashboard/mentorship/requests' }
          ]
        },
        {
          id: 'recommendations',
    ...
    if (userType === 'admin') {
      return [
        ...commonItems,
        {
          ...
          subItems: [
            { label: 'Pending Verification', href: '/dashboard/admin/pending-verification', icon: Clock },
            { label: 'Verified Users', href: '/dashboard/admin/verified-users', icon: CheckCircle },
            { label: 'Alumni List', href: '/dashboard/admin/alumni-list', icon: User },
            { label: 'Students List', href: '/dashboard/admin/students-list', icon: User }
          ]
        },
        {
          id: 'reports',
  ...
  return (
    <div className="min-h-screen bg-[#0F172A] text-white">
      ...
      <div className="flex">
        {/* Sidebar */}
        <aside className={`
          fixed lg:static lg:translate-x-0 z-50 w-64 min-h-screen bg-[#1E293B] border-r border-[#334155]
                  ...
                  <div className="ml-8 mt-2 space-y-2">
                    {item.subItems.map((subItem) => (
                      <NavLink
                        ...
                        onClick={() => setIsSidebarOpen(false)}
                      >
                        {subItem.icon && <subItem.icon className="w-3 h-3 inline mr-2" />}
                        {subItem.label}
                      </NavLink>
                    ))}
                  </div>
