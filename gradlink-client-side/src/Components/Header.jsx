    ...
    <div className='shadow-sm bg-[#0b111f] text-white backdrop-blur-md fixed z-50 top-0 w-full'>
      <div className="max-w-screen-xl mx-auto px-5 lg:px-0 navbar ">
        ...
        <div className="navbar-end">
          <Link to={'/signup'}>
            <button className='text-white shadow-none bg-gradient-to-r from-blue-500 to-emerald-400 hover:to-emerald-600 btn border-none rounded-lg font-medium transition-colors duration-200'>Sign Up</button>
          </Link>
        </div>
      </div>
    </div>
