    ...
    <div className=" max-w-screen-xl mx-auto px-5 lg:px-0 py-16">
      ...
      {!verificationMethod && (
        <div className="grid md:grid-cols-2 gap-6">
          <div
            className={`card cursor-pointer transition-all duration-300 hover:shadow-xl ${verificationMethod === "student"
          ...
          <div
            className={`card cursor-pointer transition-all duration-300 hover:shadow-xl ${verificationMethod === "alumni"
              ? "ring-2 ring-blue-500 shadow-lg"
              : ""
              }`}
